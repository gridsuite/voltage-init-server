...
public class VoltageInitParametersTest {
    ...
    public void testBuildSpecificVoltageLimits() {
        ...
        VoltageInitParametersEntity voltageInitParameters = new VoltageInitParametersEntity(UUID.randomUUID(), null, "", List.of(voltageLimit, voltageLimit2), null, null, null, 100., false);
