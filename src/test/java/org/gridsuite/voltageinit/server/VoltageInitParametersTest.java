...
public class VoltageInitParametersTest {
    ...
    public void testBuildSpecificVoltageLimits() {
        ...
        OpenReacParameters openReacParameters = voltageInitParametersService.buildOpenReacParameters(voltageInitParameters, NETWORK_UUID, VARIANT_ID_1, new HashMap<>());
        ...
        openReacParameters = voltageInitParametersService.buildOpenReacParameters(voltageInitParameters, NETWORK_UUID, VARIANT_ID_1, new HashMap<>());
