...
public class ReportServiceTest {
    ...
    private String initMockWebServer() throws IOException {
        ...
        final Dispatcher dispatcher = new Dispatcher() {
            ...
            public MockResponse dispatch(RecordedRequest request) {
                ...
                } else if (requestPath.equals(String.format("/v1/reports/%s?reportTypeFilter=VoltageInit&errorOnReportNotFound=false", REPORT_UUID))) {
    ...
    public void testDeleteReport() {
        ...
        assertThrows(RestClientException.class, () -> reportService.deleteReport(REPORT_ERROR_UUID, "VoltageInit"));
    }
}
