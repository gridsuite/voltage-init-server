 ...
 */
public class VoltageInitCancelContext {

    private final UUID resultUuid;

    private final String receiver;

    public VoltageInitCancelContext(UUID resultUuid, String receiver) {
    ...
    public static VoltageInitCancelContext fromMessage(Message<String> message) {
        ...
        return new VoltageInitCancelContext(resultUuid, receiver);
    }
